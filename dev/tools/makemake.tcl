...
#
#     1. cd dev/tools; tclsh makemake.tcl
#
...
#     pub/pkg/windows/Makefile.mingw    # makefile for mingw on windows
#     pub/pkg/windows/Makefile.*        # makefiles for other windows compilers
#
...
set srcDirExt ../../dep/vendor/extsrc
...
set extra_files {
  ...
  *.js
  ...
  sounds/*.wav
  alerts/*.wav
  ../dep/vendor/extsrc/pikchr.wasm
  ../dep/vendor/extsrc/pikchr*.js
}
...
writeln {#
##############################################################################
# WARNING: DO NOT EDIT, AUTOMATICALLY GENERATED FILE (SEE "dev/tools/makemake.tcl")
##############################################################################
#
...
$(SRCDIR_extsrc)/pikchr.js: $(SRCDIR_extsrc)/pikchr.c $(MAKEFILE_LIST)
	$(EMCC_WRAPPER) -o $@ $(EMCC_OPT) --no-entry <<<NEXT_LINE>>>
        ...
        --minify 0
	$(TCLSH) $(TOPDIR)/dev/tools/randomize-js-names.tcl $(SRCDIR_extsrc)
...
#
puts "building ../../pub/pkg/windows/Makefile.mingw"
set output_file [open ../../pub/pkg/windows/Makefile.mingw w]
fconfigure $output_file -translation binary
...
#
SRCDIR = src
SRCDIR_extsrc = dep/vendor/extsrc
SRCDIR_tools = dev/tools
...
#
ZINCDIR = $(SRCDIR)/../dep/vendor/compat/zlib
ZLIBDIR = $(SRCDIR)/../dep/vendor/compat/zlib
...
#
OPENSSLDIR = $(SRCDIR)/../dep/vendor/compat/openssl
...
#
TCLDIR = $(SRCDIR)/../dep/vendor/compat/tcl-8.6
...
$(OBJDIR)/fossil.o:	$(SRCDIR)/../pub/pkg/windows/fossil.rc $(OBJDIR)/VERSION.h
ifdef USE_WINDOWS
	...
	$(CP) $(SRCDIR)/../pub/pkg/windows/fossil.rc $(OBJDIR)
	$(CP) $(SRCDIR)/../pub/pkg/windows/fossil.ico $(OBJDIR)
	$(CP) $(SRCDIR)/../pub/pkg/windows/fossil.exe.manifest $(OBJDIR)
endif
...
writeln "\$(SQLITE3_OBJ):\t\$(SQLITE3_SRC) \$(SRCDIR)/../pub/pkg/windows/Makefile.mingw"
writeln "\t\$(XTCC) \$(SQLITE_OPTIONS) \$(SQLITE_CFLAGS) \$(SEE_FLAGS) \\"
writeln "\t\t-c \$(SQLITE3_SRC) -o \$@\n"
...
writeln "\$(OBJDIR)/shell.o:\t\$(SQLITE3_SHELL_SRC) \$(SRCDIR_extsrc)/sqlite3.h \$(SRCDIR)/../pub/pkg/windows/Makefile.mingw"
...
#
puts "building ../../pub/pkg/windows/Makefile.dmc"
set output_file [open ../../pub/pkg/windows/Makefile.dmc w]
fconfigure $output_file -translation binary
...
B      = ..
SRCDIR = $B\src
SRCDIR_extsrc = $B\dep\vendor\extsrc
SRCDIR_tools = $B\dev\tools
OBJDIR = .
O      = .obj
E      = .exe
...
DMDIR  = c:\DM
INCL   = -I. -I$(SRCDIR) -I$(SRCDIR_extsrc) -I$B\pub\pkg\windows\include -I$(DMDIR)\extra\include
...
#
puts "building ../../pub/pkg/windows/Makefile.msc"
set output_file [open ../../pub/pkg/windows/Makefile.msc w]
fconfigure $output_file -translation binary
...
INCL      = /I. /I"$(OX)" /I"$(SRCDIR)" /I"$(SRCDIR_extsrc)" /I"$(B)\pub\pkg\windows\include"
