...
EXTRA_FILES = \
  ...
  $(SRCDIR)/../pub/skins/ardoise/css.txt \
  $(SRCDIR)/../pub/skins/ardoise/details.txt \
  $(SRCDIR)/../pub/skins/ardoise/footer.txt \
  $(SRCDIR)/../pub/skins/ardoise/header.txt \
  $(SRCDIR)/../pub/skins/black_and_white/css.txt \
  $(SRCDIR)/../pub/skins/black_and_white/details.txt \
  $(SRCDIR)/../pub/skins/black_and_white/footer.txt \
  $(SRCDIR)/../pub/skins/black_and_white/header.txt \
  $(SRCDIR)/../pub/skins/blitz/css.txt \
  $(SRCDIR)/../pub/skins/blitz/details.txt \
  $(SRCDIR)/../pub/skins/blitz/footer.txt \
  $(SRCDIR)/../pub/skins/blitz/header.txt \
  $(SRCDIR)/../pub/skins/blitz/ticket.txt \
  $(SRCDIR)/../pub/skins/darkmode/css.txt \
  $(SRCDIR)/../pub/skins/darkmode/details.txt \
  $(SRCDIR)/../pub/skins/darkmode/footer.txt \
  $(SRCDIR)/../pub/skins/darkmode/header.txt \
  $(SRCDIR)/../pub/skins/default/css.txt \
  $(SRCDIR)/../pub/skins/default/details.txt \
  $(SRCDIR)/../pub/skins/default/footer.txt \
  $(SRCDIR)/../pub/skins/default/header.txt \
  $(SRCDIR)/../pub/skins/eagle/css.txt \
  $(SRCDIR)/../pub/skins/eagle/details.txt \
  $(SRCDIR)/../pub/skins/eagle/footer.txt \
  $(SRCDIR)/../pub/skins/eagle/header.txt \
  $(SRCDIR)/../pub/skins/etienne/css.txt \
  $(SRCDIR)/../pub/skins/etienne/details.txt \
  $(SRCDIR)/../pub/skins/etienne/footer.txt \
  $(SRCDIR)/../pub/skins/etienne/header.txt \
  $(SRCDIR)/../pub/skins/khaki/css.txt \
  $(SRCDIR)/../pub/skins/khaki/details.txt \
  $(SRCDIR)/../pub/skins/khaki/footer.txt \
  $(SRCDIR)/../pub/skins/khaki/header.txt \
  $(SRCDIR)/../pub/skins/original/css.txt \
  $(SRCDIR)/../pub/skins/original/details.txt \
  $(SRCDIR)/../pub/skins/original/footer.txt \
  $(SRCDIR)/../pub/skins/original/header.txt \
  $(SRCDIR)/../pub/skins/plain_gray/css.txt \
  $(SRCDIR)/../pub/skins/plain_gray/details.txt \
  $(SRCDIR)/../pub/skins/plain_gray/footer.txt \
  $(SRCDIR)/../pub/skins/plain_gray/header.txt \
  $(SRCDIR)/../pub/skins/xekri/css.txt \
  $(SRCDIR)/../pub/skins/xekri/details.txt \
  $(SRCDIR)/../pub/skins/xekri/footer.txt \
  $(SRCDIR)/../pub/skins/xekri/header.txt \
  $(SRCDIR)/accordion.js \
...
$(OBJDIR)/ai.o:	$(OBJDIR)/ai_.c $(OBJDIR)/ai.h $(SRCDIR)/config.h
	$(XTCC) -o $(OBJDIR)/ai.o -c $(OBJDIR)/ai_.c

$(OBJDIR)/ai.h:	$(OBJDIR)/headers
